import java.lang.*;
import java.io.*;
// TODO: написать функцию, которая будет определять digit это или нет, символы пробела/табуляции или нет
// при помощи этих функций создать массив char[], который содержит только числа 
class MyScanner {
