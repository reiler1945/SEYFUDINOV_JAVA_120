...
public class Main {
    static Integer MainSumResult = 0;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Zatracheno:" + (after - before));
        ...
        System.out.println("Zatracheno: " + (after - before));
        System.out.println("sumByThreads = " + sumByThreads);
        System.out.println("MainSumResult = " + MainSumResult);
    }
}